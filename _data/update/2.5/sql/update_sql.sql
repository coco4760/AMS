...
-- 20250928文档速读提测内容-start---------------

-- AGENT表新增文档速读摘要总结
INSERT INTO `clouditera_aigc`.`AGENT` (`ID`, `AGENT_NAME`, `WORKFLOW_NAME`, `AGENT_TYPE`, `TAG`, `PROMPT`, `APP_ID`, `FLAG`, `SORT`, `SHORTCUT`, `KL_STATUS`, `KEY`, `CREATED_TIME`, `CREATED_BY`, `UPDATED_TIME`, `UPDATED_BY`, `MODE_TYPE`, `CONFIG`, `VERSION`, `STATUS`, `TYPE`, `COUNT_TOKENS`, `COMMON_HOME`, `COMMON_CONVERSATION`, `COMMON_QUESTION`, `PARENT_ID`, `AGENT_METADATA`) VALUES ('120', '文档速读', '摘要总结', 'DOCUMENT_ANALYSIS', 'DOCUMENT_ANALYSIS', NULL, '9ad70873-dfef-4bb6-9eb3-ebea76d902d7', 0, 120, 0, 0, 'app-itu82b18ex3QDC93oMeFHrMy', NULL, NULL, NULL, NULL, 'CHAT_WORKFLOW', NULL, '1.3', 'AGENT_ALPHA', 'KNOWLEDGE', 1, 0, 0, 1, NULL, NULL);
-- 文档速读智能体修改prompt，mode_type
UPDATE AGENT SET PROMPT = "kb_id,doc_id",MODE_TYPE = "CHAT_WORKFLOW" WHERE ID ="9";

-- 20250928文档速读提测内容-end--------------------