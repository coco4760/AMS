...
-- clouditera_aigc.AGENT_SPECIFICATION_LINK definition
...
CREATE TABLE `AGENT_SPECIFICATION_LINK` (
  ...
  `UPDATED_BY` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '最后一次修改人',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='智能体说明-在线链接表';
...
-- clouditera_aigc.KNOWLEDGE_BASE_SCHEDULED_CONFIG definition
...
-- clouditera_aigc.OPERATION_LOG definition
...
-- clouditera_aigc.PAPER_FILE_INFO definition
...
-- clouditera_aigc.PAPER_SCHEDULED_CONFIG definition
