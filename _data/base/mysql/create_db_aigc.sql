...
-- clouditera_aigc.PAPER_PERUSE_FILE definition
...
CREATE TABLE `AI_SAST_TASK` (
  ...
  `REPOSITORY_TYPE` enum('LOCAL','GIT') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '代码仓库类型（LOCAL/GIT）',
  `REPOSITORY_URL` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '代码仓库地址',
  `REPOSITORY_BRANCH` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '代码仓库分支',
  `ERROR_MESSAGE` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT '任务失败原因',
  `CREATED_TIME` timestamp(6) NULL DEFAULT NULL COMMENT '创建时间',
  `CREATED_BY` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '创建人',
  `UPDATED_TIME` timestamp(6) NULL DEFAULT NULL COMMENT '更新时间',
