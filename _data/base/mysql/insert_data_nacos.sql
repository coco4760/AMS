...
INSERT INTO nacos.config_info (data_id,group_id,content,md5,gmt_create,gmt_modified,src_user,src_ip,app_name,tenant_id,c_desc,c_use,effect,`type`,c_schema,encrypted_data_key) VALUES
	 ('mysql','aigc','url=jdbc:mysql://192.168.34.7:13306/clouditera_aigc?serverTimezone=Asia/Shanghai
mysqlusername=root
password=Clouditera@2023','d6f565ffb77dcf30493c0831628982db','2025-08-13 01:29:01','2025-08-13 01:29:01','nacos','10.8.0.20','','',NULL,NULL,NULL,'text',NULL,''),
	 ('postgresql','aigc','url=jdbc:postgresql://192.168.34.7:15432/aigc
pgUsername=postgres
...
password=clouditera','4619795d08f94413ff0db0f8c24d3e31','2025-08-13 01:29:01','2025-08-13 01:29:01','nacos','10.8.0.20','','',NULL,NULL,NULL,'text',NULL,''),
	 ('webide','aigc','url: http://192.168.34.7:8080/','8bbb0fa94f4fdec725e8bce38328ab6b','2025-08-13 01:29:01','2025-08-13 01:29:01','nacos','10.8.0.20','','',NULL,NULL,NULL,'text',NULL,''),
	 ('dify','aigc','host: http://192.168.34.7:15001
...
ragFlowHost: http://192.168.34.7:9380
...
modelActivity: false','1c786d5f79b8012d43ef9df461c1aff9','2025-08-13 01:29:01','2025-08-13 01:29:01','nacos','10.8.0.20','','',NULL,NULL,NULL,'text',NULL,''),
	 ('plugin','aigc','host: http://192.168.34.7:18002
local-host: http://183.242.161.27:21682
search-host: http://192.168.34.7:18882
penetration-tools-host: http://192.168.34.7:18005
codeInvoke: http://192.168.34.7:18887
...
izPull: false','273a428e5c560b122d9dafa009cbb237','2025-08-13 01:29:01','2025-08-13 01:29:01','nacos','10.8.0.20','','',NULL,NULL,NULL,'text',NULL,''),
	 ('keycloak','aigc','iamUrl: http://192.168.34.7:18080
realm: Clouditera-IAM
clientId: clouditera-aigc
clientSecret: jbSM7ihAH8i5AlYlUF5fLYn5BTJEs1B5
jwkSetUri=http://192.168.34.7:18080/realms/Clouditera-IAM/protocol/openid-connect/certs
defaultPassword=P@ss1234','9d33a596812d1400d72987c1089e81d2','2025-08-13 01:29:01','2025-08-13 01:29:01','nacos','10.8.0.20','','',NULL,NULL,NULL,'text',NULL,''),
	 ('minio','aigc','endpoint: http://192.168.34.7:19000
...
secretKey: HwaJ1L5QMxSmyoO6','d0951a5c36cc24b116bd979b8395d7f6','2025-08-13 01:29:01','2025-08-13 01:29:01','nacos','10.8.0.20','','',NULL,NULL,NULL,'text',NULL,''),
	 ('searching','aigc','host: http://192.168.34.7:8000
...
summaryThreadNum: 1','5d0f6f6f4be12c97f48cdb3764c0bc25','2025-08-13 01:29:01','2025-08-13 01:29:01','nacos','10.8.0.20','','',NULL,NULL,NULL,'text',NULL,''),
	 ('secpaper','aigc','host: http://192.168.34.7:18082','a1a4a86787c1dcc431c5cf5bea232561','2025-08-13 01:29:01','2025-08-13 01:29:01','nacos','10.8.0.20','','',NULL,NULL,NULL,'text',NULL,'');
INSERT INTO nacos.config_info (data_id,group_id,content,md5,gmt_create,gmt_modified,src_user,src_ip,app_name,tenant_id,c_desc,c_use,effect,`type`,c_schema,encrypted_data_key) VALUES
	 ('rag','aigc','base-url=http://192.168.34.7:38082
...
paper-api-key=2dd13f7a99d9451db8ae751a7b069fd2','fdac4f63832158a26ff9746211220377','2025-08-13 01:29:01','2025-08-13 01:29:01','nacos','10.8.0.20','','',NULL,NULL,NULL,'text',NULL,''),
	 ('sast','aigc','host: http://192.168.34.7:8031','ca2b3454903beeea2344ea7ed469f3a4','2025-08-13 01:29:01','2025-08-13 01:29:01','nacos','10.8.0.20','','',NULL,NULL,NULL,'text',NULL,''),
...
INSERT INTO nacos.his_config_info (id,data_id,group_id,app_name,content,md5,gmt_create,gmt_modified,src_user,src_ip,op_type,tenant_id,encrypted_data_key) VALUES
	 (0,'mysql','aigc','','url=jdbc:mysql://192.168.34.7:13306/clouditera_aigc?serverTimezone=Asia/Shanghai
mysqlusername=root
password=Clouditera@2023','d6f565ffb77dcf30493c0831628982db','2025-08-13 01:29:00','2025-08-13 01:29:01','nacos','10.8.0.20','I','',''),
	 (0,'postgresql','aigc','','url=jdbc:postgresql://192.168.34.7:15432/aigc
pgUsername=postgres
password=clouditera','39f4a31d773b0c96fca028bf6f524ff8','2025-08-13 01:29:00','2025-08-13 01:29:01','nacos','10.8.0.20','I','',''),
	 (0,'redis','aigc','','ip=192.168.34.7
port=16379
index=2
password=clouditera','4619795d08f94413ff0db0f8c24d3e31','2025-08-13 01:29:00','2025-08-13 01:29:01','nacos','10.8.0.20','I','',''),
	 (0,'webide','aigc','','url: http://192.168.34.7:8080/','8bbb0fa94f4fdec725e8bce38328ab6b','2025-08-13 01:29:00','2025-08-13 01:29:01','nacos','10.8.0.20','I','',''),
	 (0,'dify','aigc','','host: http://192.168.34.7:15001
compressedAppKey: app-8yeUYPPR06MA8nXpTdXgxFG0
datasetsAppKey: dataset-gZdX8OFBpThhFbJz81nWeGlS
token: dataset-gZdX8OFBpThhFbJz81nWeGlS
ragFlowHost: http://192.168.34.7:9380
...
api-key=55a3983c0c0440c693e437df8cfb735b','fa0022442e2b0a7e6fcb06b65183fef0','2025-08-13 01:29:00','2025-08-13 01:29:01','nacos','10.8.0.20','I','',''),
	 (0,'sast','aigc','','host: http://192.168.34.7:8031','ca2b3454903beeea2344ea7ed469f3a4','2025-08-13 01:29:00','2025-08-13 01:29:01','nacos','10.8.0.20','I','',''),
	 (0,'rabbitmq','aigc','','host=192.168.34.7
port=8672
account=clouditera
