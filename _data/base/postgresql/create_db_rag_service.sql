...
CREATE TABLE public.providers ( id varchar(64) NOT NULL, provider varchar(50) NOT NULL, model_type varchar(50) NOT NULL, config_template json NOT NULL, created_at timestamp NULL, updated_at timestamp NULL, CONSTRAINT providers_pkey PRIMARY KEY (id));
